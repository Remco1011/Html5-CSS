...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
    ...
    <h2 class="kop"> Klanten van de website </h2>
    <h3 class="kop">  Klanten van </h3>
...
try{
$sQuery = "SELECT voornaam AS Voornaam,  achternaam AS Achternaam, Woonplaats AS Woonplaats Beheerdid AS idbeheerder
			FROM klant";
