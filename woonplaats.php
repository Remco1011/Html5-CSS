...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>  
    ...
    <h2 class="kop"> Deelnemers </h2> 
    <h3 class="kop"> Alle deelnemers</h3>
...
$zoek=$_POST['zoek'];
try{ 
$sQuery = "SELECT woonplaats AS woonplaats
			FROM hardlopers
            Where woonplaats like :woonplaats
            GROUP BY(woonplaats); woonplaats"
     = $db->prepare($sQuery);
			$oStmt->bindValue(:woonplaats, "%$zoek%"); 
			$oStmt->execute();	
    	if($oStmt->rowCount()>0) 
			{
