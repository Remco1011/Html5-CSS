...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
    ...
    <h2 class="kop"> Deelnemers met meeste runs </h2>
    <h3 class="kop"> Deelnemers met meeste runs </h3>
...
try{
$sQuery = "SELECT hardlopers.idhardlopers AS idhardloper, voornaam AS voornaam, tussenvoegsel AS tussenvoegsel,  achternaam AS achternaam, COUNT(*) AS Aantal
FROM `hardlopers`
INNER JOIN deelname
ON deelname.idhardlopers=hardlopers.idhardlopers
INNER JOIN runs
ON runs.idrun= deelname.idrun
GROUP BY hardlopers.idhardlopers
