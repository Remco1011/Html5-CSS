...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
    ...
    <h2 class="kop"> Deelnemers per woonplaats </h2>
    <h3 class="kop">Deelnemers per woonplaats</h3>
...
try{
$sQuery = "SELECT  woonplaats AS Woonplaats, COUNT(*) AS Aantal
FROM hardlopers
INNER JOIN deelname
ON hardlopers.idhardlopers=deelname.idhardlopers
INNER JOIN runs
ON deelname.idrun= runs.idrun
GROUP BY(woonplaats)" ;
